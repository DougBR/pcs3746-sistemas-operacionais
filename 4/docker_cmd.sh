...
qemu-system-arm -M versatilepb -m 32M -nographic -kernel $BOOT/zImage -dtb $BOOT/dts/versatile-pb.dtb \
    ...
    -drive file=build/aux_disk.img,format=raw,if=virtio,index=1 -s -S
